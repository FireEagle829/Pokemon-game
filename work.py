...
print()
ethan.add_pokemon(pikachu)
ethan.add_pokemon(charmander)
ethan.add_pokemon(wartortle)
nate.add_pokemon(suicune)
nate.add_pokemon(mewtwo)
nate.add_pokemon(bulbasaur)
# Results will appear starting from here:
nate.show_pokemons()
ethan.show_pokemons()
print()
ethan.set_active_pokemon(charmander)
nate.set_active_pokemon(bulbasaur)
print()
nate.attack(ethan)
print()
ethan.attack(nate)
